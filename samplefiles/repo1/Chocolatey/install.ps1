...
# === EDIT HERE ===
$packageRepo = 'http://pccs3.tama-st-h.local:8005/choco/'
...
if (-Not (Test-Path ($7zExe))) {
    throw "Failed to find 7zip: $7zExe"
}
...
$process.StartInfo = New-Object System.Diagnostics.ProcessStartInfo($7zExe, $params)
